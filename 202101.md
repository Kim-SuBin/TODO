...
|:---:|---|
||블로그 포스팅|
||프로젝트| - 목표 : 기본적인 Java Code 완성하기 (API는 다음주에 만들 계획)
...
|✅|블로그 포스팅|
|✅|프로젝트 - DynamoDB Management Console|
...
|Check|To Do|
|:---:|---|
|❎|코테(5시간..😂) => 27일에 보기로 결정 탕탕|
|✅|블로그 포스팅|
|✅|프로젝트 => DynamoDB CRUD 공부 및 CLI 실습, JAVA로 사용하는 법 공부|
